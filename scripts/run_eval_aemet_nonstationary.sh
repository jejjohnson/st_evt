...
#     --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_mcmc_redfeten/results/stations' \
#     --dataset-url="/home/juanjohn/projects/st_evt/data/ml_ready/aemet/t2max_stations_bm_summer.zarr" \
#     --station-id="$i"
# done

# for i in "${posterior_stations[@]}"; do
# python st_evt/_src/modules/models/aemet/eval_nonstationary_model.py evaluate-model-predictions-station \
#     --results-dataset='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_mcmc_redfeten/results/nonstationary_iid_mcmc_redfeten.zarr' \
#     --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_mcmc_redfeten/results/stations' \
#     --dataset-url="/home/juanjohn/projects/st_evt/data/ml_ready/aemet/t2max_stations_bm_summer.zarr" \
#     --station-id="$i"
...
python st_evt/_src/modules/models/aemet/eval_nonstationary_model.py evaluate-model-posterior-region \
    --results-dataset='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_mcmc_redfeten/results/nonstationary_iid_mcmc_redfeten.zarr' \
    --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_mcmc_redfeten/results/spain'
...
# for i in "${posterior_stations[@]}"; do
# python st_evt/_src/modules/models/aemet/eval_nonstationary_model.py evaluate-model-posterior-station \
#     --results-dataset='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_lap_redfeten/results/nonstationary_iid_lap_redfeten.zarr' \
#     --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_lap_redfeten/results/stations' \
#     --dataset-url="/home/juanjohn/projects/st_evt/data/ml_ready/aemet/t2max_stations_bm_summer.zarr" \
#     --station-id="$i"
# done
...
python st_evt/_src/modules/models/aemet/eval_nonstationary_model.py evaluate-model-posterior-region \
    --results-dataset='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_lap_redfeten/results/nonstationary_iid_lap_redfeten.zarr' \
    --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/nonstationary_iid_lap_redfeten/results/spain'
...
#         --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/az_nonstationary_gp_mcmc_redfeten_trainnoise/results/figures/stations/' \
#         --dataset-url="/home/juanjohn/projects/st_evt/data/ml_ready/aemet/t2max_stations_bm_summer.zarr" \
#         --station-id="$i"
# done
...
#         --figures-path='/home/juanjohn/pool_data/dynev4eo/experiments/walkthrough/aemet/t2max/az_nonstationary_gp_lap_redfeten_trainnoise/results/figures/stations/' \
#         --dataset-url="/home/juanjohn/projects/st_evt/data/ml_ready/aemet/t2max_stations_bm_summer.zarr" \
#         --station-id="$i"
# done
